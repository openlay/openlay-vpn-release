...
module.exports = {
  ...
  // WireGuard listen port (used in publicUrl for registration)
  port: process.env.WG_PORT || process.env.PORT || '51820',
  ...
  managementApiToken: process.env.MANAGEMENT_API_TOKEN || process.env.ENROLLMENT_TOKEN || '',
  ...
  apiToken: process.env.API_TOKEN || process.env.ENROLLMENT_TOKEN || '',
};
